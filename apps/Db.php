...
class Db{
	...
	public function seoInfo($metaName = 'metaTitle'){
		...
		$SEOmetaData['metaSiteName'] = "MZA CPA Professional Corporation";

		$SEOmetaData['metaTitle'] = "MZA CPA Professional Corporation | MZA CPA | Professional Corporation";

		$SEOmetaData['metaKeyword'] = "Accounting, Tax Services, Bookkeeping, Tax Preparation, Planning, Filing Needs";

		$SEOmetaData['metaDescription'] = "We Provide Accounting, Tax Services, Bookkeeping, Tax Preparation, Planning, Filing Needs.";

		$SEOmetaData['metaDomain'] = "https://mzacpa.ca/";
