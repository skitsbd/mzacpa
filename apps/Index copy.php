...
class Index {
        ...
        $returnHTML .= '
                  ...
                  while($oneRow = $bannObj->fetch(PDO::FETCH_OBJ)){
                      ...
                      if($catPics){
                        ...
                        <div class="carousel-item '.$activeCrus.'">
                            <img src="'.$catImgSrc.'" alt="Carousel Image" />
                            <div class="carousel-caption">
                                <h1 class="animated fadeInLeft">'.$name.'</h1>
                                <p class="animated fadeInRight">'.$description.'</p>
                                <a class="btn animated fadeInUp" href="#">Call for details</a>
                            </div>
                        </div>';
            ...
            <div class="feature-top">
              <div class="container-fluid">
                <div class="row align-items-center" style="margin-left: 0px !important;">';
                        ...
                        $i = 0;
                        $faIcon = [ 1=>"far fa-credit-card", 2=>"fa fa-user-tie", 3=>"far fa-thumbs-up", 4=>"far fa-handshake" ];
            ...
            <div class="service">
                <div class="container">
                    <div class="section-header">
                        <h2 class="text-center">'.$bodyPages[67][0].'</h2> 
                    </div>
                            ...
                            while($oneRow = $serviceObj->fetch(PDO::FETCH_OBJ)){
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="service-item">
                                        ...
                                        <a class="btn" href="'.$services_uri.'">Learn More</a>
                                    </div>
                                </div>';
                    ...
                    <div class="section-header">
                        <div class="col-md-12" style="padding-right:0px !important;">
                            <a class="see_more_button" href="/legal-services.html">
                                SEE ALL SERVICES <i class="fas fa-chevron-right"></i><i class="fas fa-chevron-right"></i>
                            </a> 
                        </div>                       
                    </div>
                </div>
            ...
            <!-- About Start -->
            <div class="aboutus_container" style="border: 0px solid red; ">';
                ...
                $returnHTML .= '
                <div class="image-container col-md-6 pull-right" style="border: 0px solid red;">
                    <div class="jarallax" style="background-image:url('.$photo_galleryImgUrl.');">
                    <a target="_blank" class="play-btn popup-video style2 position-center"
                        href="'.$video.'"><i class=""><i class="fas fa-play"></i></i></a>
                    </div>
                    <div class="jarallax-img2" style="height:1000px;">
                    </div>
                </div>

                <div class="aboutus_container_parlx" style="border: 0px solid red;">
                    <div class="row align-items-center">
                        <div class="col-md-5 offset-md-6" style="background-size: cover">
            
                        <h6 class="p-title">'.$bodyPages[63][1].'</h6><br />
            
                        <h2>'.$bodyPages[63][0].'</h2>
            
                        <p class="max-width-480px">'.$bodyPages[63][3].'</p>
            
                        <div class="who-feature-flex">
                            <div class="who-card">
                            <div class="who-icon-wrapper"><img src="website_assets/images/legal_beauty_1.svg" loading="eager"
                                width="48" height="48" alt=""></div>
                            <div class="who-text-wrapper">
                                <h6>'.$bodyPages[64][0].'</h6>
                                <p>'.$bodyPages[64][1].'</p>
                            </div>
                            </div>
                            <div class="who-card">
                            <div class="who-icon-wrapper"><img src="website_assets/images/legal_beauty_2.svg" loading="eager"
                                width="48" height="48" alt=""></div>
                            <div class="who-text-wrapper">
                                <h6>'.$bodyPages[65][0].'</h6>
                                <p>'.$bodyPages[65][1].'</p>
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="about-sign-box">
                            <a href="https://jahedullaw.ca/boris-kostukov">
                            <h4 class="salauddin">'.$bodyPages[66][0].'</h4>
                            </a>
                            <h6>'.$bodyPages[66][1].' </h6>
                        </div>
                ...
                <div class="aboutus_parlx_height">
                &nbsp;
                </div>
            ...
            <div class="team" style="">
              <div class="container">
                <div class="section-header">
                  <h2>'.$bodyPages[69][0].'</h2>
                </div>
                <div id="team-slider" class="team-slider owl-carousel owl-theme">';

                            $teamObj = $this->db->getObj("SELECT teams_id, name, uri_value, address FROM teams WHERE teams_publish = 1 ORDER BY RAND() LIMIT 0,3", array());
                            ...
                            if($teamObj){
                                ...
                                while($oneRow = $teamObj->fetch(PDO::FETCH_OBJ)){      
                                    ...
                                    $returnHTML .='
                                    <div class=" slide person-wrap">
                                        <img src="'.$customerImgSrc.'" class="img-fluid person-img" alt="'.$name.'">
                                        <div class="person-info opacity">
                                        <h2 class="person-name">'.$name.'</h2>
                                        <p>'.$address.'</p>
                                        <div class="social-info border-top">
                                            <div class="team-social">
                                            <a href="#"><i class="fab fa-facebook-f"></i></a>
                                            <a href="#"><i class="fab fa-youtube"></i></a>
                                            <a href="#"><i class="fab fa-instagram"></i></a>
                                            </div>
                                            <a href="'.$uri_value.'" class="person-link">See Details <i class="fas fa-arrow-right"></i></a>
                                        </div>
                                        </div>
                                    </div>';
                ...
                <div class="section-header">
                    <div class="col-md-12" style="padding-right:0px !important; margin-top: 10px !important;">
                        <a class="see_more_button" href="/our-team.html">
                            SEE OUR ALL ATTORNEYS <i class="fas fa-chevron-right"></i><i class="fas fa-chevron-right"></i>
                        </a> 
                    </div>                       
                </div>
              </div>
                                                                    ...
                                                                    <div class=\"col-lg-12 col-md-12 rs-box\">                                                
                                                                            ...
                                                                            <div class=\"team-item\">
                                                                                ...
                                                                                <div class=\"team-img\">
                                                                                    ...
                                                                                    <img src=\"".$customerImgSrc."\" alt=\"".$name."\" style=\"width:70% !important;\">
                                        ...
                                        while($oneRow = $FMObj->fetch(PDO::FETCH_OBJ)){            
                                            ...
                                            if($FMObj2){     
                                                ...
                                                while($oneRow2 = $FMObj2->fetch(PDO::FETCH_OBJ)){
                                                    ...
                                                    $manuStr .= "<li><a href=\"/legal-services$subMenuUri\" style=\"font-style: normal; font-weight: 300; font-display: swap;\" >
            ...
            <div class=\"card card-with-shadow\">
                    ...
                    <div class=\"content\"> 
                            ...
                            <ul>";              
                                    ...
                                    $FMSql = "SELECT front_menu_id, name, menu_uri FROM front_menu WHERE root_menu_id  = 13 AND sub_menu_id = 0 AND front_menu_id = 14 AND front_menu_publish = 1 ORDER BY menu_position ASC";
    ...
    private function footerHTML(){	  
        ...
        $htmlStr ='<!-- Footer Start -->
            ...
            <script src="website_assets/js/jquery-3.4.1.min.js"></script>
